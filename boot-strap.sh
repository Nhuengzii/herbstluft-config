yay -S polybar ranger picom-jonaburg-git kitty herbstluftwm rofi dunst nitrogen nodejs npm neovim ueberzug docker brightnessctl go github-cli zsh cargo lazygit noto-fonts-emoji --noconfirm
